      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            ...
            <Link
              href="https://drive.google.com/file/d/1iWhX6MrLq3GuIAiBh7lyUD3VmRiYyKIu/view?usp=drive_link"
              target="blank"
        ...
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5 }}
          className="col-span-4 place-self-center mb-4 lg:mt-0"
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              src="/images/Happy_cartoon_b_0.png"
